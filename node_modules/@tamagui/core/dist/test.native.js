  ...
  "../web/dist/cjs/helpers/ThemeManager.native.js"(exports, module2) {
    ...
    var uid = 0, ThemeManager = class {
      ...
      updateState(nextState, shouldNotify = !0) {
        ...
        this.isComponent = lastName[0] === lastName[0].toUpperCase(), this._allKeys = null, this.scheme = names[0] === "light" ? "light" : names[0] === "dark" ? "dark" : null, shouldNotify && queueMicrotask(() => {
          this.notify();
        });
      }
      ...
      onChangeTheme(cb, debugId) {
        return this.themeListeners.add(cb), () => {
    ...
    function getState(props, parentManager) {
      ...
      if (!props.name && !props.inverse && !props.reset && !props.componentName || props.reset && !isDirectParentAComponentTheme && !(parentManager != null && parentManager.parentManager))
        return null;

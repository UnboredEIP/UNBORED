...
function createComponent(staticConfig) {
  ...
  const component = (0, import_react.forwardRef)((propsIn, forwardedRef) => {
    var _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m, _n, _o;
    ...
    if (process.env.NODE_ENV === "development") {
      ...
      if (debugProp && debugProp !== "profile") {
        const name = `${componentName || (Component == null ? void 0 : Component.displayName) || (Component == null ? void 0 : Component.name) || "[Unnamed Component]"}`, type = isAnimatedReactNative ? "(animated)" : isReactNative ? "(rnw)" : "", dataIs = propsIn["data-is"] || "", banner = `${name}${dataIs ? ` ${dataIs}` : ""} ${type} id ${id}`;
        console.group(
...
` && console.error(
    ...
    events && !isReactNative && Object.assign(viewProps, getWebEvents(events)), process.env.NODE_ENV === "development" && time && time`events`, process.env.NODE_ENV === "development" && debugProp === "verbose" && console.info("events", { events, isHoverable, attachPress }), (_k = (_j = import_setupHooks.hooks).useEvents) == null || _k.call(_j, viewProps, events, splitStyles, setStateShallow, staticConfig);
    ...
    process.env.NODE_ENV, content = (0, import_react.createElement)(elementType, viewProps, content), import_setupHooks.hooks.useChildren && (content = (_m = (_l = import_setupHooks.hooks).useChildren) == null ? void 0 : _m.call(_l, content, viewProps, events, staticConfig)), process.env.NODE_ENV === "development" && time && time`create-element`;
  ...
  function styleable(Component2, options) {
    var _a2;
    const ComponentForwardedRef = ((_a2 = Component2.render) == null ? void 0 : _a2.length) === 2 ? Component2 : (

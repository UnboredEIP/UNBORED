...
function Settings() {
  ...
  const defaultImageUri = 'https://camo.githubusercontent.com/c870c9266f63ef17356bc6356d7c2df99d8a9889644352d4fe854f37f5c13693/68747470733a2f2f692e706f7374696d672e63632f5071674c68726e582f756e626f7265642e706e67'; // Replace with the actual default image URL
  ...
  >
    <View style={styles.container}>
              ...
              {image ? (<Image source={{ uri: image }}   style={{left:20,width:250, height:250, borderRadius:600/2}}/>) : 
            (<Image source={{ uri: defaultImage }}   style={{left:20,width:250, height:250, borderRadius:600/2}}/>)}
  ...
  <Image style={styles.image4} source={require('./assets/camera.png')} />
  </TouchableOpacity>
  <TouchableOpacity style={styles.oauthBtn} onPress={pickImage2}>
  <Image style={styles.image4} source={require('./assets/gallery.png')} />
  </TouchableOpacity>
  </View>
      <TextInput
        style={styles.input}
